...
public class Main {
    public static void main(String[] args) throws FileNotFoundException{
        ...
        String sCurrentLine;
        Processes.br = new BufferedReader(new FileReader("resources/eficiencia.txt"));
        Processes.k = new Vector<Integer>(100);
        try {
			while ((sCurrentLine = Processes.br.readLine()) != null) {
				Processes.k.add(Integer.valueOf(sCurrentLine));
			}
        ...
        while (choise != 9){
	        ...
	        if (choise == 1 || choise == 2 || choise == 3){
		        ...
		        if (choise == 1){
		        	...
		        	w2 = comunicator.reifyWaterWithPrefixAndDelete("rio", volumen, industria);
